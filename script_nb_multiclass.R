...
#Data preprocessing
#
#Convert to corpus. Trainingdata should only include the text and the coding variable (in this case called "Sentiment")
...
nbModel<-textmodel_nb(TrainingDTM,docvars(TrainingDTM,"Sentiment"))
...
#
#Get real values
actual_class <- docvars(matchedDFM, "Sentiment")
